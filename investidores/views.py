...
def ver_empresa(request, id):
    ...
    return render(request, "ver_empresa.html",
        {"empresa": empresa, "documentos": documentos, "percentual_vendido": int(percentual_vendido), "concretizado": concretizado, "percentual_disponivel": percentual_disponivel})
...
def assinar_contrato(request, id):
    ...
    if request.method == "GET":
        ...
        messages.add_message(request, constants.SUCCESS, "Assinado!")
